...
unit_base_costs = {
    ...
    'Dehaka': {
        ...
        'DehakaMutaliskLevel3': (0, 25, 200, 125),
    ...
    'Fenix': {  # I will need to add Champions with (0,0,X,Y)
        'AdeptFenix': (100, 40),
    ...
    'Karax': {
        ...
        'Probe': (0, 0),
        'Reaver': (0, 0),
        'SOAPurifierBeamUnit': (0, 0),
        'SOAThermalLanceTargeter': (0, 0),
        'Scout': (0, 0),
        'SentryPurifier': (0, 0),
        'SiegeTank': (0, 0),
        'SiegeTankSieged': (0, 0),
    ...
    'Kerrigan': {
        ...
        'HotSTorrasque': (0, 0),
        'HydraliskLurker': (0, 0),
        'HydraliskLurkerBurrowed': (0, 0),
        'HydraliskLurkerEgg': (0, 0),
        'K5Kerrigan': (0, 0),
        'LurkerBurrowed': (0, 0),
        'MutaliskBroodlord': (0, 0),
        'QueenClassic': (0, 0),
        'QueenCoop': (0, 0),
        'SpineCrawler': (0, 0),
        'SporeCrawler': (0, 0),
    ...
    'Mengsk': {
        'ArtilleryMengsk': (0, 0),
        'BattlecruiserMengsk': (0, 0),
        'CommanderPrestigeMengskTrooperBoom': (0, 0),
        'CoopCasterMengsk': (0, 0),
        'GhostMengsk': (0, 0),
        'HydraliskMengsk': (0, 0),
        'MarauderMengsk': (0, 0),
        'MissileTurretMengsk': (0, 0),
        'MutaliskMengsk': (0, 0),
        'SCVMengsk': (0, 0),
        'SiegeTankMengsk': (0, 0),
        'SiegeTankMengskSieged': (0, 0),
        'ThorMengsk': (0, 0),
        'ThorMengskSieged': (0, 0),
        'TrooperMengsk': (0, 0),
        'TrooperMengskAA': (0, 0),
        'TrooperMengskFlamethrower': (0, 0),
        'TrooperMengskImproved': (0, 0),
        'UltraliskMengsk': (0, 0),
        'VikingMengskFighter': (0, 0),
        'ZerglingMengsk': (0, 0)
    },
    'Nova': {
        'Banshee_BlackOps': (0, 0),
        'CoopCasterNova': (0, 0),
        'GhostFemale_BlackOps': (0, 0),
        'Ghost_BlackOps': (0, 0),
        'Goliath_BlackOps': (0, 0),
        'HellbatBlackOps': (0, 0),
        'HellionBlackOps': (0, 0),
        'LiberatorAG_BlackOps': (0, 0),
        'Liberator_BlackOps': (0, 0),
        'Marauder_BlackOps': (0, 0),
        'Marine_BlackOps': (0, 0),
        'MissileTurret': (0, 0),
        'NovaACLaserTurret': (0, 0),
        'NovaBoombotBurrowed': (0, 0),
        'NovaCoop': (0, 0),
        'NovaCoopDecoy': (0, 0),
        'Raven_BlackOps': (0, 0),
        'SCV': (0, 0),
        'SiegeTankSieged_BlackOps': (0, 0),
        'SiegeTank_BlackOps': (0, 0),
        'SpiderMine': (0, 0)
    },
    'Raynor': {
        'ArchAngelCoopAssault': (0, 0),
        'Banshee': (0, 0),
        'Battlecruiser': (0, 0),
        'Bunker': (0, 0),
        'CoopCasterRaynor': (0, 0),
        'DuskWing': (0, 0),
        'Firebat': (0, 0),
        'HyperionVoidCoop': (0, 0),
        'Marauder': (0, 0),
        'Marine': (0, 0),
        'MissileTurret': (0, 0),
        'SCV': (0, 0),
    ...
    'Stetmann': {
        'BanelingStetmann': (0, 0),
        'BroodLordStetmann': (0, 0),
        'BroodlingEscortStetmann': (0, 0),
        'BroodlingStetmann': (0, 0),
        'CorruptorStetmann': (0, 0),
        'DroneStetmann': (0, 0),
        'GaryStetmann': (0, 0),
        'HydraliskStetmann': (0, 0),
        'InfestorStetmann': (0, 0),
        'InfestorStetmannBurrowed': (0, 0),
        'InterceptorStetmann': (0, 0),
        'LurkerStetmannBurrowed': (0, 0),
        'RavagerStetmann': (0, 0),
        'RoachStetmann': (0, 0),
        'SpineCrawlerStetmann': (0, 0),
        'SporeCrawlerStetmann': (0, 0),
        'SuperGaryStetmann': (0, 0),
        'UltraliskStetmann': (0, 0),
        'ZerglingStetmann': (0, 0)
    },
    'Stukov': {
        'ArchAngelCoopAssault': (0, 0),
        'Banshee': (0, 0),
        ...
        'LiberatorAG': (0, 0),
        'Mutalisk': (0, 0),
        'NovaInfestedBanshee': (0, 0),
        'Oracle': (0, 0),
        'Phoenix': (0, 0),
        'SIBroodlingFlying': (0, 0),
        'SIInfestedBunkerUprooted': (0, 0),
        'SIInfestedCivilian': (0, 0),
        'SIInfestedMarine': (0, 0),
        'SIInfestedTrooper': (0, 0),
        'SILiberator': (0, 0),
        'SIMissileTurret': (0, 0),
        'SIQueen': (0, 0),
        'SISCV': (0, 0),
        'SIVolatileInfested': (0, 0),
        'Scourge': (0, 0),
        'Scout': (0, 0),
        'StukovAleksander': (0, 0),
        'StukovAleksanderCrashed': (0, 0),
        'StukovApocalisk': (0, 0),
        'StukovInfestBroodling': (0, 0),
        'StukovInfestedBanshee': (0, 0),
        'StukovInfestedBansheeBurrowed': (0, 0),
        'StukovInfestedDiamondBack': (0, 0),
        'StukovInfestedSiegeTank': (0, 0),
        'StukovInfestedSiegeTankUprooted': (0, 0),
        'Tempest': (0, 0),
        'VikingFighter': (0, 0),
        'Viper': (0, 0),
        'VoidRay': (0, 0)
    ...
    'Swann': {
        'Cyclone': (0, 0),
        'DrakkenLaserDrillCoop': (0, 0),
        'Goliath': (0, 0),
        'Hellion': (0, 0),
        'HellionTank': (0, 0),
        'KelMorianGrenadeTurret': (0, 0),
        'KelMorianMissileTurret': (0, 0),
        'PerditionTurret': (0, 0),
        'SCV': (0, 0),
        'ScienceVessel': (0, 0),
        'SiegeTank': (0, 0),
    ...
    'Tychus': {
        ...
        'Hydralisk': (0, 0),
        'Immortal': (0, 0),
        'InfestedAbomination': (0, 0),
        'Interceptor': (0, 0),
        'Liberator': (0, 0),
        'LiberatorAG': (0, 0),
        'LurkerBurrowed': (0, 0),
        'LurkerMPBurrowed': (0, 0),
        'Ravager': (0, 0),
        'Reaver': (0, 0),
        'Roach': (0, 0),
        'Scout': (0, 0),
        ...
        'TychusReaper': (0, 0),
        'TychusSCV': (0, 0),
        'TychusSCVAutoTurret': (0, 0),
        'TychusSpectre': (0, 0),
        'TychusWarhound': (0, 0),
        'TychusWarhoundAutoTurret': (0, 0),
        'Ultralisk': (0, 0),
        'VikingAssault': (0, 0),
        'VikingFighter': (0, 0),
        'VoidRay': (0, 0),
    ...
    'Zagara': {
        'ArchAngelCoopAssault': (0, 0),
        'Baneling': (0, 0),
        'BileLauncherZagara': (0, 0),
        'Broodling': (0, 0),
        'Corruptor': (0, 0),
        'Drone': (0, 0),
        'HotSSplitterlingBig': (0, 0),
    ...
    'Zeratul': {
        ...
        'BroodlingEscort': (0, 0),
        'Colossus': (0, 0),
        'CommanderPrestigeZeratulTornadoesTornado': (0, 0),
        'Cyclone': (0, 0),
        'HERC': (0, 0),
        'Immortal': (0, 0),
        'InfestedAbomination': (0, 0),
        ...
        'VoidRay': (0, 0),
        'ZeratulCoop': (0, 0),
        'ZeratulDarkArchon': (0, 0),
        'ZeratulDarkTemplar': (0, 0),
        'ZeratulDisruptor': (0, 0),
        'ZeratulHeroDarkArchon': (0, 0),
        'ZeratulImmortal': (0, 0),
        'ZeratulKhaydarinMonolith': (0, 0),
        'ZeratulKhaydarinMonolithProjection': (0, 0),
        'ZeratulPhotonCannon': (0, 0),
        'ZeratulPhotonCannonProjection': (0, 0),
        'ZeratulSentry': (0, 0),
        'ZeratulStalker': (0, 0),
        'ZeratulStalkerGhost': (0, 0),
        'ZeratulSummonKarass': (0, 0),
        'ZeratulSummonVoidRay': (0, 0),
        'ZeratulSummonZealot': (0, 0),
        'ZeratulXelNagaChargedCrystalCyan': (0, 0),
        'ZeratulXelNagaConstruct': (0, 0),
        'ZeratulXelNagaConstructCyan': (0, 0)
    }
}