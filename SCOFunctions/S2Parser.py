...
valid_protocols = {81102: 81433, 80871: 81433, 76811: 76114, 80188: 78285, 79998: 78285}
protocols = [
    ...
    77535, 77661, 78285, 80669, 80949, 81009, 81433, 82457, 82893, 83830
]
...
def s2_parse_replay(file,
    ...
    if replay_build != used_build and not replay_build in valid_protocols:
        logger.info(f'Succesfully replaced build {replay_build} with build {used_build}!')
